...
{
    internal static IEndpointRouteBuilder MapNotificationEndpoints(this IEndpointRouteBuilder builder)
    {
    ...
    private static async Task<IResult> GetNotificationsAsync(
        INotificationService service, HttpContext context, CancellationToken cancellationToken)
    {
    ...
    private static async Task<IResult> UpdateNotificationAsync(
        INotificationService service, HttpContext context, int id, CancellationToken cancellationToken)
    {
